DROP DATABASE festival; /*ajout*/
CREATE DATABASE festival; /*ajout*/
use festival; /*ajout*/
...
motDePasse varchar(8), /*ajout*/
informationsPratiques varchar(200), /*ajout*/
conventionSignee boolean not null, /*ajout*/
